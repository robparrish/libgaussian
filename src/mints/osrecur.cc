...
{
    if (max_am1 < 0)
        throw std::logic_error("ObaraSaikaTwoCenterMIRecursion -- max_am1 must be nonnegative");
    if (max_am2 < 0)
        throw std::logic_error("ObaraSaikaTwoCenterMIRecursion -- max_am2 must be nonnegative");
//    if (max_m > 3)
...
void ObaraSaikaTwoCenterMIRecursion::compute(double PA[3], double PB[3], double gamma, int am1, int am2)
{
    if (am1 < 0 || am1 > max_am1_)
        throw std::logic_error("ERROR: ObaraSaikaTwoCenterMIRecursion::compute -- am1 out of bounds");
    if (am2 < 0 || am2 > max_am2_)
        throw std::logic_error("ERROR: ObaraSaikaTwoCenterMIRecursion::compute -- am2 out of bounds");
    int i, j, k;
...
{
    if (max_am1 < 0)
        throw std::logic_error("ERROR: ObaraSaikaTwoCenterMVIRecursion -- max_am1 must be nonnegative");
    if (max_am2 < 0)
        throw std::logic_error("ERROR: ObaraSaikaTwoCenterMVIRecursion -- max_am2 must be nonnegative");
...
{
    if (max_am1 < 0)
        throw std::logic_error("ERROR: ObaraSaikaTwoCenterRecursion -- max_am1 must be nonnegative");
    if (max_am2 < 0)
        throw std::logic_error("ERROR: ObaraSaikaTwoCenterRecursion -- max_am2 must be nonnegative");
...
{
    if (am1 < 0 || am1 > max_am1_)
        throw std::logic_error("ERROR: ObaraSaikaTwoCenterRecursion::compute -- am1 out of bounds");
    if (am2 < 0 || am2 > max_am2_)
        throw std::logic_error("ERROR: ObaraSaikaTwoCenterRecursion::compute -- am2 out of bounds");
...
{
    if (max_am1 < 0)
        throw std::logic_error("ERROR: ObaraSaikaTwoCenterVIRecursion -- max_am1 must be nonnegative");
    if (max_am2 < 0)
        throw std::logic_error("ERROR: ObaraSaikaTwoCenterVIRecursion -- max_am2 must be nonnegative");
...
{
    if (max_am1 < 0)
        throw std::logic_error("ERROR: ObaraSaikaThreeCenterRecursion -- max_am1 must be nonnegative");
    if (max_am2 < 0)
        throw std::logic_error("ERROR: ObaraSaikaThreeCenterRecursion -- max_am2 must be nonnegative");
    if (max_am3 < 0)
        throw std::logic_error("ERROR: ObaraSaikaThreeCenterRecursion -- max_am3 must be nonnegative");
                                             ...
                                             int amC)
{
    if (amA < 0 || amA > max_am1_)
        throw std::logic_error("ERROR: ObaraSaikaThreeCenterRecursion::compute -- am1 out of bounds");

    if (amB < 0 || amB > max_am2_)
        throw std::logic_error("ERROR: ObaraSaikaThreeCenterRecursion::compute -- am2 out of bounds");

    if (amC < 0 || amC > max_am3_)
        throw std::logic_error("ERROR: ObaraSaikaThreeCenterRecursion::compute -- am3 out of bounds");
